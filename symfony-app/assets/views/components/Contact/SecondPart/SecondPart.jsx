    ...
    return (
        <div>
            ...
            <div className="d-flex flex-column col-12 flex-md-row justify-content-center justify-content-md-start justify-content-xl-center align-items-center mb-5 mx-md-auto my-4">
                <div
                    className="d-flex justify-content-center justify-content-xl-start col-12 col-md-6 col-xl-3 mb-5 mt-2 me-xl-5"
                    data-aos="fade-up"
                >
                    <img
                        className="w-75 opacity-75"
                        src={mail}
                        alt="mail"
                        loading="lazy"
                    />
                    ...
                    <form onSubmit={submitForm} data-aos="fade-up">
                        ...
                        <div class="form-check">
                            ...
                            >
                                    ...
                                    mes données soient stockées sur les serveurs
                                    appartenant à deviteasy, dans le cadre d'une
                                    utilisation non commercial. (Obligatoire)
                            </label>
                        </div>
                        {send ? (
