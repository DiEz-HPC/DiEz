...
class HomeController extends AbstractController
{
    ...
    public function index(VisitorCounterService $visitorCounterService, ConfigurationTheme $theme): Response
    {
        ...
        if ($_ENV['APP_ENV'] === 'prod') {
            header("Content-Security-Policy: default-src '*'; img-src 'self' data: https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' *; style-src 'self' 'unsafe-inline' https:; font-src 'self' data: https:; connect-src 'self' https://analytics.caprover.deviteasy.fr/ https://1218.3cx.cloud/MyPhone/config/tensthinkerdev; base-uri 'self';");
